...
interface HasArrayEq : WorksWithFormulas {
    infix fun CellRangeReference.isEqualTo(number: Number) = ArrayEq(type(), number.type())
    infix fun CellRangeReference.isEqualTo(reference: CellReference) = ArrayEq(type(), reference.type())
